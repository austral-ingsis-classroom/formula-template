...
public class ResolutionWithVariablesTest {
  ...
  public void shouldResolveFunction1() {
    final Double result = new Addition(
            new Constant(1),
            new Variable("x")).evaluate(Map.of("x", 3d));
  ...
  public void shouldResolveFunction2() {
    final Double result = new Division(
            new Constant(12),
            new Variable("div")).evaluate(Map.of("div", 4d));
  ...
  public void shouldResolveFunction3() {
    final Double result = new Multiplication(
            ...
            new Variable("y")).evaluate(Map.of("x", 3d, "y", 4d));
  ...
  public void shouldResolveFunction4() {
    final Double result = new Elevate(
            ...
            new Variable("b")).evaluate(Map.of("a", 9d, "b", 3d));
  ...
  public void shouldResolveFunction5() {
    final Double result = new Elevate(
            new Variable("z"),
            new Parenthesis(new Division(new Constant(1), new Constant(2)))).evaluate(Map.of("z", 36d));
  ...
  public void shouldResolveFunction6() {
    final Double result = new Subtraction(
            new Module(new Variable("value")),
            new Constant(8)).evaluate(Map.of("value", 8d));
  ...
  public void shouldResolveFunction8() {
    final Double result = new Multiplication(
            ...
            new Constant(8)).evaluate(Map.of("i", 2d));
